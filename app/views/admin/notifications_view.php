...
<?php $notification = $data['notification']; ?>
    <head>
        <meta charset="UTF-8">
            ...
            <div class="grid-1">
                ...
                <div>
                    <div class="card-white">
                        <p class="">Notification | (No. <?php echo $notification->notification_id;?>)</p>
                        <div class="card-green-5">
                            <div>
                                <p class="p-regular-green" style="font-size: 15px;"><b>Author: </b><?php echo $notification->author;?></p>
                                <p class="p-regular-green" style="font-size: 15px;"><b>Subject: </b><?php echo $notification->subject;?></p>
                                <p class="p-regular-green" style="font-size: 15px;"><b>User Type: </b><?php echo $notification->user_type;?></p>
                                <p class="p-regular-green" style="font-size: 15px;"><b>Created at: </b><?php echo $notification->created_at;?></p><br>
                                <p class="p-regular-green" style="font-size: 15px; text-align:justify;"><b>Content: </b><?php echo $notification->content;?></p><br> 
                        ...
                        <div class="card-green-5">
                            <form action="" method="POST">
                                <div style="font-size: 15px;">
                                    ...
                                    <select name="user_type" id="" style="margin-bottom: 15px;">
