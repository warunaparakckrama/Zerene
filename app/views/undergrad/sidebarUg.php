<?php $profilepic = $data['profilepic'];
?>
<head>
    <meta charset="UTF-8">
...
<body>
    <div class="sidebar-grid">
        ...
        <div class="sidebar-container2">
            <img src="<?php echo $profilepic; ?>" alt="ug avatar" width="80" height="80">
        ...
        <div class="sidebar-container3">
            ...
            <a href="<?php echo URLROOT; ?>undergrad/view_timeslotpc" class="top <?php echo ($currentPage === 'view_timeslotpc') ? 'active' : ''; ?>">Timeslots</a>
