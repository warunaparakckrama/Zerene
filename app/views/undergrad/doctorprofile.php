            ...
            <div>
                <div class="card-white">
                    ...
                    <div class="card-green-2">
                        <div>
                            <img src="<?php echo IMG;?>doc-avatar1.svg" alt="profile picture" class="card-profile-2">
                        </div>
                        <div>
                            <p class="p-regular" style=" margin-bottom: -10px;">Dr. Malani Fonseka</p>
                            <p class="p-regular" style="color: var(--zerene-grey);">University Psychiatrist | General Hospital - Colombo</p>
                            <p class="p-regular" style="color: var(--zerene-grey); font-size: 15px;">fonsekam@ghcolombo.gov.lk</p>
