                ...
                <div class="card-white">
                    ...
                    <div class="card-green-7">
                            <form action="<?php echo URLROOT; ?>Procounsellor/editTimeslot/<?php echo $data['timeslot']->slot_id; ?>" method="POST" id="timeslotForm">
                                ...
                                <input type="time" id="slot_start" name="slot_start" class="time" value="<?php echo $data['timeslot']->slot_start; ?>">
                                <span class="error-message"><?php echo $data['slot_start_err']; ?></span><br>

                                <label for="slot_finish">Finish : </label>
                                <input type="time" id="slot_finish" name="slot_finish" class="time" value="<?php echo $data['timeslot']->slot_finish; ?>">
