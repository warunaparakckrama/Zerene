                        ...
                        <div class="rectangle">
                            ...
                            <table>
                                <tr>
                                    ...
                                    <td class="p-title"><?php echo $pharmacy->pharmacy_name;?></td>
                                </tr>
                                <tr>
                                    <td class="p-regular-grey">Address</td>
                                    <td class="p-regular-grey">:</td>
                                    <td class="p-title"><?php echo $pharmacy->pharmacy_address;?></td>
                                </tr>
                                <tr>
                                    <td class="p-regular-grey">Email</td>
                                    <td class="p-regular-grey">:</td>
                                    <td class="p-title"><?php echo $user_details->email;?></td>
                                </tr>
                            </table>
                        </div>
