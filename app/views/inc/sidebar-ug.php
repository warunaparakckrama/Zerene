    ...
    <body>
        <div class="sidebar-grid">
            ...
            <div class="sidebar-container3">
                ...
                <a href="<?php echo URLROOT; ?>undergrad/view_timeslotpc" class="top <?php echo ($currentPage === 'view_timeslotpc') ? 'active' : ''; ?>" id="sb-link3">Professional Cousellor</a>
                <a href="<?php echo URLROOT; ?>undergrad/academiccounsellors" class="top <?php echo ($currentPage === 'academiccounsellors') ? 'active' : ''; ?>" id="sb-link4">Academic Cousellor</a>
