    ...
    <body>
        <div class="sidebar-grid">
            ...
            <div class="sidebar-container3">
                ...
                <a href="<?php echo URLROOT; ?>undergrad/professionalcounsellors" class="top <?php echo ($currentPage === 'professionalcounsellors') ? 'active' : ''; ?>" id="sb-link3">Counsellors (Prof.)</a>
                <a href="<?php echo URLROOT; ?>undergrad/academiccounsellors" class="top <?php echo ($currentPage === 'academiccounsellors') ? 'active' : ''; ?>" id="sb-link4">Counsellors (Acad.)</a>
