            ...
            <div class="card-white">
                ...
                <div class="card-green-5">
                    ...
                    <div class="btn-container">
                       <a href="<?php echo URLROOT;?>academic/ac_create_op_letter/<?php echo $letter->from_ug_user_id;?>" style="text-decoration: none;"><button class="button-main">Create Opinion Letter</button></a>
                    </div>
                </div>
            </div>
        </div>
