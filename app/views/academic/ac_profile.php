                    ...
                    <div class="subgrid-4">
                        ...
                        <div class="rectangle">
                            ...
                            <form name="changePwdAcademic" action="<?php echo URLROOT; ?>Academic/changePwdAcademic/<?php echo $_SESSION['user_id']; ?>" method="POST" class="subgrid-1" style="font-size: 15px;">
                                ...
                                <!-- <p class="p-error"><?php echo isset($data['current_password_err']) ? $data['current_password_err'] : ''; ?></p> -->
                                ...
                                <!-- <p class="p-error"><?php echo isset($data['new_password_err']) ? $data['new_password_err'] : ''; ?></p> -->
                                ...
                                <!-- <p class="p-error"><?php echo isset($data['confirm_password_err']) ? $data['confirm_password_err'] : ''; ?></p> -->
                        ...
                        <div class="rectangle">
                            ...
                            <form name="changeUsernameAcademic" action="<?php echo URLROOT; ?>Academic/changeUsernameAcademic/<?php echo $_SESSION['user_id']; ?>" method="POST" class="subgrid-1" style="font-size: 15px;">
                                ...
                                <!-- <p class="p-error"><?php echo isset($data['current_username_err']) ? $data['current_username_err'] : ''; ?></p> -->

                                <label for="nusername" class="p-regular-grey">Password :</label>
                                <input type="password"  name="password" required>
                                <!-- <p class="p-error"><?php echo isset($data['new_username_err']) ? $data['new_username_err'] : ''; ?></p> -->
