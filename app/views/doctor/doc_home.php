    ...
    ?>
                ...
                <div class="subgrid-1">
                    ...
                    <div class="subgrid-2">
                        ...
                        <a href="<?php echo URLROOT . "doctor/doc_undergrad/" ;?>" style="text-decoration: none;"> <button class="button-main" style="margin-left: 0px">Undergraduates<?php if ($data['notification'] > 0){
