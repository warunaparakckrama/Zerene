...
class User
{
    ...
    public function register($data)
    {
        ...
        if ($userInserted) {
            $this->db->query('INSERT INTO undergraduate (age, gender, email, university, faculty, study_year, username, password, user_id) VALUES(:age, :gender, :email, :university, :faculty, :year, :username, :password, :user_id)');
    ...
    public function reg_admin($data)
    {
        ...
        if ($userInserted) {
            $this->db->query('INSERT INTO admin (username, email, password, user_id) VALUES(:username, :email, :password, :user_id)');
            $this->db->bind(':username', $data['username']);
            $this->db->bind(':email', $data['email']);
            $this->db->bind(':password', $data['password']);
            $this->db->bind(':user_id', $user_id);
    ...
    public function reg_counselor($data)
    {
        ...
        if ($userInserted) {
            $this->db->query('INSERT INTO counsellor (coun_type, first_name, last_name, gender, dob, university, faculty, email, username, password, user_id) VALUES(:coun_type, :fname, :lname, :gender, :dob, :university, :faculty, :email, :username, :password, :user_id)');
            // Bind values
    ...
    public function reg_doctor($data)
    {
        ...
        if ($userInserted) {
            $this->db->query('INSERT INTO doctor (first_name, last_name, gender, uni_in_charge, hospital, email, contact_num, username, password, user_id) VALUES(:fname, :lname, :gender, :university, :hospital, :email, :contact_num, :username, :password, :user_id)');
            // Bind values
            $this->db->bind(':fname', $data['fname']);
            $this->db->bind(':lname', $data['lname']);
            $this->db->bind(':gender', $data['gender']);
    ...
    {   
        ...
        if ($userInserted) { 
            $this->db->query('INSERT INTO pharmacy (pharmacy_name, pharmacy_address, contact_num, user_id) VALUES(:name, :address, :contact_num, :user_id)');
            // Bind values
